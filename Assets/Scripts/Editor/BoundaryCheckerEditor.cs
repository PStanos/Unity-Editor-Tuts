...
public class BoundaryCheckerEditor : Editor
{
    ...
    private void DrawNewPathButton(BoundaryChecker checker)
    {
    ...
    private void DrawMainPathNodePopup(BoundaryChecker checker)
    {
    ...
    private void DrawCustomLocationControls(BoundaryChecker checker)
    {
    ...
    private void DrawCreateNewBeforeButton(BoundaryChecker checker)
    {
    ...
    private void DrawCreateNewAfterButton(BoundaryChecker checker)
    {
    ...
    private void DrawDeleteNodeButton(BoundaryChecker checker)
    {
    ...
    private void DrawForkOptions(BoundaryChecker checker)
    {
